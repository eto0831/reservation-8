...
class ShopsTableSeeder extends Seeder
{
    ...
    public function run()
    {
        $param = [
            ...
            'image_url' => 'https://coachtech-matter.s3-ap-northeast-1.amazonaws.com/image/sushi.jpg', // 画像パス
        ];
        ...
        $param = [
            ...
            'image_url' => 'https://coachtech-matter.s3-ap-northeast-1.amazonaws.com/image/yakiniku.jpg', // 画像パス
        ];
        DB::table('shops')->insert($param);
        ...
        $param = [
            ...
            'image_url' => 'https://coachtech-matter.s3-ap-northeast-1.amazonaws.com/image/izakaya.jpg', // 画像パス
        ];
        DB::table('shops')->insert($param);
        ...
        $param = [
            ...
            'image_url' => 'https://coachtech-matter.s3-ap-northeast-1.amazonaws.com/image/italian.jpg', // 画像パス
        ];
        DB::table('shops')->insert($param);
        ...
        $param = [
            ...
            'image_url' => 'https://coachtech-matter.s3-ap-northeast-1.amazonaws.com/image/ramen.jpg', // 画像パス
        ];
        DB::table('shops')->insert($param);
